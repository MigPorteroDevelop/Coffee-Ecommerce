...
<template>
  <header class="py-5 header">
    <div class="container-xl">
      <div class="row justify-content-center justify-content-md-between">
        <div class="col-8 col-md-3">
          <a href="index.html">
            <img class="img-fluid" src="/public/img/logo.png" alt="img logo">
          </a>
        </div>
        <nav class="col-md-6 a mt-5 d-flex align-items-start justify-content-end">
          <div class=cart>
            <img class="img-fluid" src="/public/img/cart.png" alt="imagen cart" />
            ...
            <div id=cart class="bg-white p-3">
              ...
              <table class="w-100 table">
                ...
                <tbody>
                  <tr>
                    <td>
                      <img class="img-fluid" src="/public/img/guitar_02.jpg" alt="img guitar">
                    </td>
                    <td>SRV</td>
                    <td class="fw-bold">
                      $299
    ...
    <img class="header-guitarra" src="/public/img/header_guitar.png" alt="imagen header">
  </header>
  ...
  <main class="container-xl mt-5">
    ...
    <div class="row mt-5">
      <div class="col-md-6 col-lg-4 my-4 row align-items-center">
        <div class="col-4">
          <img class="img-fluid" src="/public/img/guitar_01.jpg" alt="img guitar">
        </div>
        <div class="col-8">
      ...
      <div class="col-md-6 col-lg-4 my-4 row align-items-center">
        <div class="col-4">
          <img class="img-fluid" src="/public/img/guitar_03.jpg" alt="img guitar">
        </div>
        <div class="col-8">
      ...
      <div class="col-md-6 col-lg-4 my-4 row align-items-center">
        <div class="col-4">
          <img class="img-fluid" src="/public/img/guitar_04.jpg" alt="img guitar">
        </div>
        <div class="col-8">
      ...
      <div class="col-md-6 col-lg-4 my-4 row align-items-center">
        <div class="col-4">
          <img class="img-fluid" src="/public/img/guitar_05.jpg" alt="img guitar">
        </div>
        <div class="col-8">
      ...
      <div class="col-md-6 col-lg-4 my-4 row align-items-center">
        <div class="col-4">
          <img class="img-fluid" src="/public/img/guitar_06.jpg" alt="img guitar">
        </div>
        <div class="col-8">
      ...
      <div class="col-md-6 col-lg-4 my-4 row align-items-center">
        <div class="col-4">
          <img class="img-fluid" src="/public/img/guitar_07.jpg" alt="img guitar">
        </div>
        <div class="col-8">
      ...
      <div class="col-md-6 col-lg-4 my-4 row align-items-center">
        <div class="col-4">
          <img class="img-fluid" src="/public/img/guitar_08.jpg" alt="img guitar">
        </div>
        <div class="col-8">
      ...
      <div class="col-md-6 col-lg-4 my-4 row align-items-center">
        <div class="col-4">
          <img class="img-fluid" src="/public/img/guitar_09.jpg" alt="img guitar">
        </div>
        <div class="col-8">
      ...
      <div class="col-md-6 col-lg-4 my-4 row align-items-center">
        <div class="col-4">
          <img class="img-fluid" src="/public/img/guitar_10.jpg" alt="img guitar">
        </div>
        <div class="col-8">
      ...
      <div class="col-md-6 col-lg-4 my-4 row align-items-center">
        <div class="col-4">
          <img class="img-fluid" src="/public/img/guitar_11.jpg" alt="img guitar">
        </div>
        <div class="col-8">
      ...
      <div class="col-md-6 col-lg-4 my-4 row align-items-center">
        <div class="col-4">
          <img class="img-fluid" src="/public/img/guitar_12.jpg" alt="img guitar">
        </div>
        <div class="col-8">
  ...
  <footer class="bg-dark mt-5 py-5">
    <div class="container-xl">
      <p class="text-white text-center fs-4 mt-4 m-md-0">DreamGuitar - All Rights Reserved</p>
    </div>
  </footer>
</template>
